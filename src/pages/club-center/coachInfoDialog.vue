          ...
          <el-col :span="12">
            <el-form-item :class="rotate" prop="img" label="照片">
              <el-upload
                ...
                :before-upload="beforeUpLoad" :class="rotate" v-bind:disabled="isDisabled">
        ...
        <el-row>
          <el-col :span="12">
            <el-form-item prop="chineseName" label="中文名">
              <el-input style="width: 220px" v-model.trim="dialogForm.chineseName" clearable maxlength=20
                        placeholder="中文名" v-bind:disabled="isDisabled"/>
            </el-form-item>
          </el-col>
          <el-col :span="12">
            <el-form-item prop="mobile" label="手机号">
              <el-input style="width: 220px" v-model.trim="dialogForm.mobile" clearable maxlength=11
        ...
        <el-row>
          <el-col :span="12">
            <el-form-item prop="englishName" label="英文名">
              <el-input style="width: 220px" v-model.trim="dialogForm.englishName" clearable maxlength=20
                        placeholder="英文名" v-bind:disabled="isDisabled"/>
            </el-form-item>
          </el-col>
          <el-col :span="12">
            <el-form-item prop="nationality" label="国籍">
              <el-input style="width: 220px" v-model.trim="dialogForm.nationality" clearable maxlength=20
        ...
        <el-row>
          <el-col :span="12">
            <el-form-item prop="height" label="身高">
              <el-input style="width: 220px" v-model.trim="dialogForm.height" clearable maxlength=4
                        v-bind:disabled="isDisabled">
          ...
          <el-col :span="12">
            <el-form-item prop="weight" label="体重">
              <el-input style="width: 220px" v-model.trim="dialogForm.weight" clearable maxlength=4
                        v-bind:disabled="isDisabled">
        ...
        <el-row>
          ...
          <el-col :span="12">
            <el-form-item prop="status" label="状态">
              <el-select style="width: 220px" v-model="dialogForm.status" clearable placeholder="请选择"
                         v-bind:disabled="isDisabled">
        ...
        <el-row>
          <el-col :span="12">
            <el-form-item prop="remark" label="备注">
              <el-input type="textarea" style="width: 220px" v-model.trim="dialogForm.remark" clearable maxlength=50
                        v-bind:disabled="isDisabled">
              </el-input>
            </el-form-item>
          </el-col>
          <el-col :span="12"
            ...
            <el-form-item prop="share" label="比例">
              <el-input style="width: 220px" v-model.trim="dialogForm.share" clearable
                        placeholder="比例" v-bind:disabled="isDisabled">
...
<style>
  /*间距*/
  .coach-center-dialog .el-dialog {
    width: 700px !important;
  }

  .coach-center-dialog h4 {
    color: #888;
    font-weight: normal;
  }

  .coach-center-dialog .el-dialog__body {
    overflow: hidden;
    padding: 20px 30px 30px !important;
  }

  .coach-center-dialog .el-input.is-disabled .el-input__inner {
  ...
  .coach-center-dialog .el-input.is-disabled .el-input__icon {
